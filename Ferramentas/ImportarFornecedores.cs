...
{
    public class ImportarFornecedores
    {
        private readonly FornecedorDAL _fornecedorDAL;

        public ImportarFornecedores()
        {
        ...
        public async Task ExecutarImportacaoAsync(ProgressBarCustom.ProgressBarCustom progressBar)
        {
            using (OpenFileDialog dialog = new OpenFileDialog())
            {
                ...
                dialog.Title = "Selecione o Arquivo CSV de Fornecedores";
                ...
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    using (var reader = new StreamReader(caminhoCSV))
                    {
                        ...
                        {
                            MessageBox.Show("Estrutura inválida! O cabeçalho deve conter todas as colunas de Fornecedores.",
                        ...
                        progressBar.Value = 0;
                        progressBar.DisplayText = "Aguarde, realizando importação de fornecedores...";
                        ...
                        while (!reader.EndOfStream)
                        {
                            ...
                            try
                            {
                                ...
                                await _fornecedorDAL.InserirFornecedorAsync(fornecedor);
                                totalImportados++;
